...
<?php
            ...
            if (isset($_POST['forgot_password'])) {
                ...
                $url = "localhost//parkingGrid/new_password.php?token1=". $token1 . "&token2=" . bin2hex($token2);
                ...
                {    
                   ...
                   // $message = "<p>We received a password reset request for ";
                    ...
                    $from = "vekariakomal001@gmail.com";
